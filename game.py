"""
Houses our Game class, which manages the behavior and 
data needed to run a Space Invaders game
"""
...
class Game: 
    def __init__(self, stdscr):
        ...
        self.window = self.stdscr.getmaxyx() # gets height and width (y, x) of the stdscr window
