...
class Player:
    def __init__(self, stdscr, window):
        ...
        self.width = 6
        self.window = window
        self.range = (0, self.window[1] - self.width) # range of valid x values for the player
        self.speed = 1
        self.color = 3
        self.x = self.window[1] // 2 # puts the player in the middle of the screen (horizontally)
